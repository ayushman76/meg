	       ...
	       <div class="row">
		       <div class="col-md-4">
			       <div class="footer_widget">
				       <h1>My Navigation</h1>
					   <ul class="nav">
						  <li><a href="index.html">${footer[0].nav01}</a></li>
						  <li><a href="about.html">${footer[0].nav02}</a></li>
						  <li><a href="treatment.html">${footer[0].nav03}</a></li>
						  
						  <li><a href="gallery.html">${footer[0].nav05}</a></li>
						  <li><a href="contact.html">${footer[0].nav06}</a></li>
					   </ul>
			       </div>
			   </div>
			   <div class="col-md-4">
